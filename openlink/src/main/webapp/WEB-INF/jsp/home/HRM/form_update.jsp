...
function complete(param){
    location.href = "formDetail.do?FORM_CD=" + param;
 }
		...
		<div class="panel panel-default">
			...
			<c:if test="${sessionScope.user_id != null && sessionScope.user_id != ''}">
				<div class="panel-body">
					<div class="row">
						<form name="formForm" class="form-inline" method="post">
								...
								<c:forEach var="HRMList" items="${HRMList}">
									<thead>
										...
										<tr>
											...
											<td><input type="text" id="FORM_CD" name="FORM_CD" value="${HRMList.formCd}" style=" width:100%;" readOnly></td>
									...
									<tbody>
										...
										<tr>
											...
											<td><input type="text" id="FORM_NAME" name="FORM_NAME" value="${HRMList.formName}" style=" width:100%;"></td>
										</tr>
										<tr>
						...
						<div class="panel-body text-center">
							<button type="button" class="btn btn-primary" onclick="return insertForm();" id="insertFormBtn">서식 수정</button>
						</div>
						<div class="panel-body">
						<form id="fileUploadForm" method="post" enctype="multipart/form-data">
							<c:forEach var="HRMList" items="${HRMList}">
								<input type="hidden" name="FORM_CD" value="${HRMList.formCd}">
							</c:forEach>
							<table class="table table-hover text-center">
								...
								<tbody>
									<tr>
										<td style="vertical-align:middle; text-align:center;">서식</td>
										<td><input type="file" id="FILENAME_form" name="FILENAME_form"></td>
										<td><button type="button" class="btn btn-primary" onclick="return docUpload('form');" id="docUploadBtn_form">업로드</button></td>
									</tr>
									<tr>
...
function insertForm(){ 
	...
	var param = $("form[name=formForm]").serialize();
	 ...
	 $.ajax({  
	   type: "POST",
	   url: "<c:url value='/formUpdateOk.do'/>",
	   data: param,
