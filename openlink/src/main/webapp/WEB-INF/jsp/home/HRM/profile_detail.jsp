...
function goList(){
    location.href="profileList.do?CT_ID=all";
 }
 
 function updateProfile(proCd){
	 location.href="profileUpdate.do?PRO_CD=" + proCd;
 }
 
 function deleteProfile(proCd){
	 var result = confirm("프로필을 삭제하시겠습니까?");
	 if(result){
		 location.href="deleteProfileOK.do?PRO_CD=" + proCd;
	 }
 }
</script>
	<div class="container">
			...
			<div class="panel-footer">
				...
				<c:if test="${sessionScope.user_id != null && sessionScope.user_id != ''}">
					...
					<div class="panel-body text-center">
						<c:forEach var="HRMList" items="${HRMList}">
							<button type="button" class="btn btn-primary" onclick="updateProfile('${HRMList.proCd}');">수정하기</button>
							<button type="button" class="btn btn-danger" onclick="deleteProfile('${HRMList.proCd}');">삭제하기</button>
